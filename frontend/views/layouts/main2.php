...
<?php $this->beginPage() ?>
    ...
    <header class="header">
        <div class="header__top pt-3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <h2 class="text-primary"><a class="text-primary" href="/">Winkel.uz</a></h2>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                    ...
                    <nav class="header__menu">
                        <ul>
                            ...
                            foreach ($category as $item) {
                                ?>
                                <li class="active"><a
                                            href="<?= Url::to(['shop/category-views', 'id' => $item->id]) ?>"><?= $item->name_uz ?></a>
                                </li>
                                <?php
                            }
                            ?>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: Uzbekistan Samarkand</li>
                            <li>Phone: +998934980462</li>
                            <li>Email: elmurodsuyunov02@gmail.com</li>
                        </ul>
                    </div>
                </div>
